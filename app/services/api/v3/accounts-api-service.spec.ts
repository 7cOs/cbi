...
describe('AccountsApiService', () => {
  ...
  describe('getAccountProductMetrics', () => {
    ...
    it('should call the getAccountProductMetrics endpoint and return ProductMetricsDTO data', (done) => {
  ...
  describe('getSubAccounts', () => {
    it('should call the accounts/subAcccount endpoint and return subAccounts', (done) => {
      ...
      accountsApiService.getSubAccounts(accountIdMock, positionIdMock, filterStateMock.premiseType)
