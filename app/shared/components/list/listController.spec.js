describe('Unit: list controller', function() {
  ...
  describe('Add to target list functionality; [list.addToTargetList]; [list.toggleSelectAllStores]', function() {
  ...
  describe('selectAll functionality; [list.toggleOpportunitiesInStores]; [list.toggleSelectAllStores]', function() {
    beforeEach(function() {
      opportunitiesService.model.opportunities = [
        {
          'id': '1430039___80014014___20160929',
  ...
  describe('Remove opportunity from Target List; [list.updateOpportunityModel]', function() {
    var selected = [
      {
  ...
  describe('Collaborators functionality; [list.addToSharedCollaborators]; [list.removeSharedCollaborator]', function() {
  ...
  describe('Depletions vs YA %; [list.depletionsVsYaPercent]', function() {
    var opportunityArr = [];
