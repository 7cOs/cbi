...
describe('Unit: list controller', function() {
  ...
  describe('sendDownloadEvent GA events', () => {
    ...
    it('when target list details page and csvDownloadOption is With Rationales', () => {
      ctrl.pageName = 'target-list-detail';
    ...
    it('when target list details page and csvDownloadOption is Without Rationales', () => {
      ctrl.pageName = 'target-list-detail';
    ...
    it('when target list details page and csvDownloadOption is Stores', () => {
      ctrl.pageName = 'target-list-detail';
