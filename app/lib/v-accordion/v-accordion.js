...
/**
 * NOTE: This is a customized version of the v-accordion component which
 * disables animations, and optimizes max-height css setting for IE11 speed.
 * Changes from the original source will be noted with "// CBI CHANGED" comments.
 */
    ...
    .animation('.is-expanded', [ '$animateCss', 'accordionConfig', function ($animateCss, accordionConfig) {
      return {
        addClass: function (element, className, done) {
          ...
          // CBI CHANGED - Remove animation/transition, and allow browser to calculate height instead
          // of calling offsetHeight and setting max-height, which is slow in IE11
        ...
        removeClass: function (element, className, done) {
          ...
          // CBI CHANGED - Remove animation/transition, and eliminate calculation of offsetHeight
          // since it is no longer needed for animation (calculation of which is slow in IE11)
