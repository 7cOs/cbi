...
module.exports = function (config) {
  ...
  config.api = {
    ...
    v3BaseUrls: {
      ...
      products: 'https://cbi-product-metrics-api-qa.herokuapp.com'
    }
  };
  ...
  config.auth = {
    ...
    user: {
      ...
      'jwt': 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..-_-OTq1tXp3oXougHECCwD8xKoGXSPYAX3wdEMrH9t4',
      'jwtmap': {
        'firstName': 'JOHN',
        'lastName': 'UTTER',
        'corporateUser': false,
