...
module.exports = function (config) {
  ...
  config.auth = {
    ...
    user: {
      ...
      'jwt': 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..LVIbAg54asnc-Whl4ZHH2cXniPnRdVHOxiqIUH6Vq9c',
      'jwtmap': {
        'firstName': 'JOHN',
        'lastName': 'UTTER',
        'corporateUser': false,
